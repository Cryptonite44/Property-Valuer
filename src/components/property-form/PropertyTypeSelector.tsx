        ...
        <Tooltip key={type}>
          <TooltipTrigger asChild>
            <motion.button
              ...
              className={`relative p-4 rounded-xl text-center transition-all overflow-hidden flex flex-col items-center justify-center h-full
                ${selectedType === type
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center">
                <motion.div 
                  className={`flex items-center justify-center w-16 h-16 mb-3 rounded-full 
                ...
                >
                  <div className={`text-2xl ${selectedType === type ? 'text-white' : 'text-white/70'}`}>
                    {icon}
                  </div>
                </motion.div>
                <span className={`text-sm font-medium ${selectedType === type ? 'text-white' : 'text-white/70'}`}>
                  {label}
                </span>
              </div>
