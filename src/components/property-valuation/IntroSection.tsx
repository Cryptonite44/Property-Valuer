        ...
        <div className="perspective-[1200px] overflow-hidden relative">
          ...
          >
            ...
            <div className="relative group perspective">
              ...
              {/* Enhanced mobile title with stronger colors and pop effect */}
              <motion.h1
                className="relative text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-[0.8] md:leading-[0.9] py-4 px-6"
                initial={{ scale: 0.9 }}
                animate={{ 
                  scale: 1,
                  textShadow: [
              ...
              >
                {/* Mobile-enhanced title with letter effects */}
                <div className="inline-block xs:hidden">
                  <motion.span 
                    className="inline-block text-transparent bg-clip-text bg-gradient-to-br from-fuchsia-500 via-purple-500 to-violet-500 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]"
                    animate={{
                  ...
                  <br />
                  <motion.span
                    className="inline-block text-transparent bg-clip-text bg-gradient-to-br from-indigo-500 via-blue-600 to-cyan-500 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]"
                    animate={{
              ...
              <motion.div
                className="absolute inset-0 xs:hidden bg-gradient-to-br from-fuchsia-500/10 via-violet-500/10 to-blue-500/10 rounded-3xl -z-10"
                animate={{
                  opacity: [0.4, 0.6, 0.4],
              ...
              {/* Enhanced mobile pop effect - burst animation */}
              <motion.div 
                className="absolute inset-0 xs:hidden -z-10"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-600/20 via-purple-500/10 to-blue-600/20 rounded-3xl blur-md" />
              </motion.div>
            ...
            >
              ...
              <div className="flex items-center justify-center">
                ...
                {/* Enhanced sparkles icon with dynamic glow - more visible on mobile */}
                <motion.div
                  ...
                  animate={{
                    y: [-3, 3, -3],
                    rotate: [-5, 15, -5],
                    scale: [0.9, 1.15, 0.9]  // Enhanced scale effect
                  }}
                  transition={{
                    duration: 4,
                    repeat: Infinity,
                ...
                >
                  ...
                  <motion.div
                    className="absolute inset-0 rounded-full bg-yellow-400/50 blur-md -z-10"
                    animate={{
                      scale: [1, 1.8, 1],
                  ...
                  <motion.div
                    className="absolute inset-0 -z-20 rounded-full bg-yellow-300/30 blur-xl"
                    animate={{
                      scale: [1.2, 2.2, 1.2],
          ...
          {/* Enhanced mobile-specific subtitle with stronger styling */}
          <motion.div 
          ...
          >
            {/* Enhanced divider */}
            <motion.div 
              className="h-1 w-28 bg-gradient-to-r from-fuchsia-500/80 via-indigo-500/80 to-blue-500/80 rounded-full mx-auto mb-6"
              animate={{
                width: ["40%", "70%", "40%"],
                opacity: [0.7, 1, 0.7],
                boxShadow: [
            ...
            <motion.p 
              className="text-white text-sm font-medium px-4 py-2 rounded-lg bg-gradient-to-r from-purple-900/30 to-indigo-900/30 backdrop-blur-sm border border-white/10"
              animate={{
                opacity: [0.8, 1, 0.8],
                boxShadow: [
