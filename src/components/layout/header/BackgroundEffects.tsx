        ...
        <motion.div 
          className={`absolute inset-0 ${
            isDark 
              ...
              : "bg-gradient-to-b from-white/90 via-indigo-100/20 to-transparent"
          } backdrop-blur-lg`}
          animate={{
        ...
        <motion.div
          className={`absolute -top-[200px] -left-[100px] w-[500px] h-[500px] rounded-full ${
            isDark
              ...
              : "bg-gradient-to-r from-indigo-300/10 via-purple-300/5 to-transparent"
          } blur-3xl`}
          animate={{
            x: [0, 30],
            opacity: isDark ? [0.3, 0.4] : [0.2, 0.3],
            scale: [1, 1.05],
          }}
          transition={{
            duration: 8,
        ...
        <motion.div
          className={`absolute -bottom-[200px] -right-[100px] w-[500px] h-[500px] rounded-full ${
            isDark
              ...
              : "bg-gradient-to-r from-blue-300/10 via-indigo-300/5 to-transparent"
          } blur-3xl`}
          animate={{
            x: [0, -30],
            opacity: isDark ? [0.2, 0.3] : [0.1, 0.2],
            scale: [1, 1.05],
          }}
          transition={{
            duration: 10,
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <AnimatePresence>
          {sparkles.map(sparkle => (
            <motion.div
              key={sparkle.id}
              className={`absolute rounded-full ${isDark ? "bg-white" : "bg-gray-500"}`}
              style={{
                left: `${sparkle.x}%`,
                top: `${sparkle.y}%`,
